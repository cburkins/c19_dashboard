...
class WidgetChartJMixedChartBarLine extends React.Component {
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    constructor(props) {
        ...
        this.state = { widgetName: "WidgetChartJMixedChartBarLine", chartData: [] };
    ...
    render() {
        ...
        return (
            <CardContainer id={this.props.id} position={this.props.position} color={this.props.color} widgetName="WidgetChartJMixedChartBarLine">
                <DashboardChartJSCard>
                    {/* Title */}
                    <div className="single-num-title">Mixed Chart Bar Line(Chart.js)</div>
...
WidgetChartJMixedChartBarLine.defaultProps = {};

// Force the caller to include the proper attributes
WidgetChartJMixedChartBarLine.propTypes = {
...
export default withTheme(WidgetChartJMixedChartBarLine);
